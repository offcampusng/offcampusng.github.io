  ...
  public: {
    Tables: {
      ...
      bookings: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["hostel_id"]
            isOneToOne: false
            referencedRelation: "hostels_public"
            referencedColumns: ["id"]
          },
          {
      ...
      hostel_views: {
        ...
        Relationships: [
          {
            foreignKeyName: "hostel_views_hostel_id_fkey"
            columns: ["hostel_id"]
            isOneToOne: false
            referencedRelation: "hostels"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "admin" | "user" | "landlord" | "agent"
